...
$db = new SQLite3('ticket_camp_neo.sqlite');

/////temp
//http://ticketcamp.net/3434902/

/*
detailPage('http://ticketcamp.net','http://ticketcamp.net/3469204/','3469204',$db);
echo '<hr />';
exit;
*/
/////temp　end
...
//    		break;
    ...
    echo '<hr />_page'.$i.' _cnt_c'.$cnt_c.'<hr />';
    exit;
}
