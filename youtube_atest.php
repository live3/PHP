...
player = new YT.Player('player', {
  ...
  vq: 'small',
  playerVars: { 'playsinline': 1, 'controls': 2, 'autohide': 1, 'enablejsapi':1, 'showinfo':0,'rel':0,'controls':2,'iv_load_policy':3,'origin':'http://util.live3.info' },
  events: {
...
//a.onclick = wo;
/*
a.onclick = function() { alert("I was clicked!"); };
a.onclick();
*/
a.click();
